...
class RotaryPositionalEncoding(nn.Module):
    ...
    ## Added position_offset for cached inference
...
# ------------------------------------------------------------------------------
# ----------------------------- DeepSeek Attention -----------------------------
# ---------- Multi-Head Latent Attention (MLA) + Decoupled RoPE Module ---------
# ------------------------------------------------------------------------------
...
class MiniDeepSeek(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor, targets: Optional[torch.Tensor] = None, mtp_weight: float = 0.1, past_kv_cache: Optional[list] = None):
        ...
        if targets is None:
            ## Calculate position offset based on past cache
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        ## Pass the old cache to the model
