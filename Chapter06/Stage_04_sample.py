...
import torch
import tiktoken
from .Stage_02_model import ModelArgs, MiniDeepSeek

## Import the serialization module to handle the new security feature
...
def load_latest_checkpoint(directory: str):
    ...
    Args:
        directory (str): Path to the directory containing checkpoints.
        
    Returns:
        dict: The loaded checkpoint dictionary, or None if no checkpoints found.
    """
